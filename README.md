About langgraph-checkpoint-aws-feedstock
========================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langgraph-checkpoint-aws-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langgraph-checkpoint-aws-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langgraph-checkpoint-aws
# for installing globally
pixi global install langgraph-checkpoint-aws
```
...
It is possible to list all of the versions of `langgraph-checkpoint-aws` available on your platform:
...
```
pixi search langgraph-checkpoint-aws --channel conda-forge
```
